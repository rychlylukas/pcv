...
myself_binary=0b10101101 #LukášRyc
#? Vypište toto binární číslo v desítkové soustavě
print('Výpis v desítkové soustavě:')
...
hexa_cislo = 0x1A
cislo1 = int(myself_binary)
cislo2 = int(hexa_cislo)
vysledek = cislo1 & cislo2
print(vysledek)
#? Výsledek zobrazte jako formátovaný řetězec - např. "Binární součin čísla 0b11010 a 0b10110101 je 0b10000"
print('Binární součin čísla {} a {} je {}'.format(bin(0x1a), bin(myself_binary), bin(vysledek)))
