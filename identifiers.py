...
x = 0
# global = 1 Proměnná, která je rezervovaná pro Python.
cislo_global = 1
PI = 3.14
city = "Opava"
# hilda@sspu-opava.cz = 'Hilda Dokonalá' Je zde užit neplatný symbol.
hildaSspuOpavaCz = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
# 007agent = 'James Bond' Proměnná začíná numerickým znakem.
agent007 = 'James Bond'
